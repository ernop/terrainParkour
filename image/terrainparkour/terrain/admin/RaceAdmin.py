...
class RaceAdmin(OverriddenModelAdmin):
    list_display='id mystart myend distance myruns mybestruns created mytop10 myevents'.split()
    ...
    mystart, myend, myruncount, myruns, mybestruns, mytop10, myevents=adminify(mystart, myend, myruncount, myruns, mybestruns, mytop10, myevents)
