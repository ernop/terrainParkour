...
class RobloxUserAdmin(OverriddenModelAdmin):
    list_display='id userId mytix myplaytime mybanLevel username created myjoins mychats myquits mysources mydeaths myruns myfinds mybestruns mytoptens mywrs'.split()
    ...
    myjoins, mytix, myplaytime, mybanLevel, mychats, myquits, mysources, mydeaths, myruns, myfinds, mybestruns, mywrs, mytoptens=adminify(myjoins, mytix, myplaytime, mybanLevel, mychats, myquits, mysources, mydeaths, myruns, myfinds, mybestruns, mywrs, mytoptens)
