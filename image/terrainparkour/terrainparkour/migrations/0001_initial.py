# Generated by Django 2.2 on 2019-07-07 01:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assetId', models.IntegerField(db_column='assetid')),
            ],
            options={
                'db_table': 'badge',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('userId', models.IntegerField(db_column='userid', unique=True)),
                ('username', models.CharField(max_length=30)),
                ('banLevel', models.IntegerField(db_column='banlevel', default=0)),
            ],
            options={
                'db_table': 'robloxuser',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('y', models.FloatField(blank=True, null=True)),
                ('z', models.FloatField(blank=True, null=True)),
                ('calcFinds', models.IntegerField(db_column='calcfinds', default=0)),
                ('calcNearest', models.ForeignKey(db_column='calcnearest_id', default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nearest_to', to='terrainparkour.Sign')),
            ],
            options={
                'db_table': 'sign',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requestsource', models.ForeignKey(db_column='requestsource_id', on_delete=django.db.models.deletion.CASCADE, related_name='chatmessages', to='terrainparkour.RequestSource')),
                ('user', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='chatmessages', to='terrainparkour.RobloxUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raceMilliseconds', models.IntegerField(db_column='racemilliseconds')),
                ('speed', models.FloatField(default=0)),
                ('race', models.ForeignKey(db_column='race_id', on_delete=django.db.models.deletion.CASCADE, related_name='bestruns', to='terrainparkour.Race')),
                ('user', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='bestruns', to='terrainparkour.RobloxUser')),
            ],
            options={
                'db_table': 'bestrun',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('badge', models.ForeignKey(db_column='badge_id', on_delete=django.db.models.deletion.CASCADE, related_name='badgegrants', to='terrainparkour.Badge')),
                ('user', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='badgegrants', to='terrainparkour.RobloxUser')),
            ],
            options={
                'db_table': 'badgegrant',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_column='user_id', default=None, on_delete=django.db.models.deletion.CASCADE, related_name='actionresultssent', to='terrainparkour.RobloxUser')),
            ],
            options={
